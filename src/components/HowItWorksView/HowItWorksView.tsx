...
import { HowItWorksViewProps } from 'src/types';

const HowItWorksView1: any = styled('div')({
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
...
function HowItWorksView(props: HowItWorksViewProps): JSX.Element {
  return (
    <HowItWorksView1 className={props.className}>
      <Container>
        <MainContent>
